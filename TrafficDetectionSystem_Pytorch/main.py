...
def init(id,ip):
    ...
    # 自行设置,url为推送的服务器地址
    rtmpUrl = "rtmp://192.168.219.55:1935/stream/"+str(id)
            ...
            for item_bbox in list_bboxs:
                ...
                if polygon_mask_blue_and_yellow[y, x] == 1:
                    ...
                    if track_id in list_overlapping_yellow_polygon:
                        ...
                        req = requests.post("http://localhost:8080/api/detection",json=data)  # 发post请求,以json字符串参数格式
                        print(req)
...
if __name__ == '__main__':
    req = requests.get("http://localhost:8080/api/camera")  # 发post请求,以json字符串参数格式
